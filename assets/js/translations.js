const translations = {
  fr: {
    ...
    "experience_tech": "Projets Techniques Sélectionnés",
    ...
    "exp_ecollecte": "Développeur Full-Stack (Stage) — Projet E-Collecte",
    "exp_ecollecte_loc": "ISERP - Antanetibe, Analamanga, Madagascar",
    "exp_ecollecte_d1": "Application mobile Flutter de collecte de données sur le terrain, avec 47 Écrans, 11 Providers (State), 15 Routes API, 12 Tables BDD, 8 Widgets réutilisables, 3 Services.",
    "exp_ecollecte_d2": "Back-end Node.js/TypeScript avec Express.js, Prisma ORM et MySQL.",
    "exp_ecollecte_d3": "Projet réalisé en toute autonomie, de la conception à la livraison.",
    "exp_commune": "Développeur Web (Stage)",
    "exp_commune_loc": "Commune Urbaine de Fianarantsoa - Fianarantsoa, Madagascar",
    "exp_commune_d1": "Création d'un site web pour la Gestion de l'urbanisme avec PHP & WordPress.",
    "exp_commune_d2": "Réalisé en hybride, en toute autonomie.",
    ...
    "date_stage1": "Sept. 2023 – Nov. 2023",
    "skills_title": "Mes Compétences",
    "skill_lang": "Langages (JS/TS, Python, Dart, SQL, Prolog, PHP)",
    "skill_front": "Frontend (React, Flutter, React Native, HTML/CSS)",
  ...
  en: {
    ...
    "experience_tech": "Selected Technical Projects",
    ...
    "exp_ecollecte": "Full-Stack Developer (Internship) — E-Collecte Project",
    "exp_ecollecte_loc": "ISERP - Antanetibe, Analamanga, Madagascar",
    "exp_ecollecte_d1": "Flutter mobile application for field data collection, featuring 47 Screens, 11 Providers (State), 15 API Routes, 12 DB Tables, 8 reusable Widgets, 3 Services.",
    "exp_ecollecte_d2": "Node.js/TypeScript backend with Express.js, Prisma ORM, and MySQL.",
    "exp_ecollecte_d3": "Project completed in full autonomy, from conception to delivery.",
    "exp_commune": "Web Developer (Internship)",
    "exp_commune_loc": "Commune Urbaine de Fianarantsoa - Fianarantsoa, Madagascar",
    "exp_commune_d1": "Creation of an urban planning management website with PHP & WordPress.",
    "exp_commune_d2": "Completed in a hybrid setup, in full autonomy.",
    ...
    "skill_lang": "Languages (JS/TS, Python, Dart, SQL, Prolog, PHP)",
    "skill_front": "Frontend (React, Flutter, React Native, HTML/CSS)",
    "skill_back": "Backend (Node.js, Express, Flask, Prisma)",
